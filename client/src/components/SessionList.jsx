...
export const SessionList = ({ sessions, onDeleteSession, onDeleteUndo }) => {
  return (
    <>
      ...
      <div className="ideaDeleteUndoButtonWrapper">
        <button className="ideaDeleteUndoButton" onClick={() => onDeleteUndo(idea.id)}>
          Undo Delete Of Idea
        </button>
      </div>
